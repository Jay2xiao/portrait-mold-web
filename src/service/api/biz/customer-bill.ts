...
export interface CustomerBillItemVO {
  ...
  repairPreviewFileIds?: string;
  printSpecs?: Array<{
    id?: string | number;
    printTaskId?: string | number;
    heightCm?: number | string | null;
    quantity?: number | null;
    estimatedWeightG?: number | string | null;
    estimatedAmount?: number | string | null;
    actualEntityWeightG?: number | string | null;
    actualSupportWeightG?: number | string | null;
    actualEntityUnitPrice?: number | string | null;
    actualSupportUnitPrice?: number | string | null;
